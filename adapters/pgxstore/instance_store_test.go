...
func TestInstanceStore(t *testing.T) {
	...
	// Test Update (Optimistic Locking Failure)
	// TODO: Enable this test once optimistic locking is fully implemented in pgxstore.Update
	/*
		staleInst := inst
		staleInst.UpdatedAt = now // Old timestamp
